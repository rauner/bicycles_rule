...
pop_scaling_2010_EU = remind.query('Variable == ("Population") and Region.str.contains("World")', engine='python')[str(year)].iloc[0]/remind.query('Variable == ("Population") and Region.str.contains("EUR")', engine='python')['2010']
...
pop_scaling_2015 = (1-bike_share/car_load_factor)*remind.query('Variable == ("Population") and Region.str.contains("World")', engine='python')[str(year)]/remind.query('Variable == ("Population") and Region.str.contains("World")', engine='python')['2015']
pop_scaling_2040 = (1-bike_share/car_load_factor)*remind.query('Variable == ("Population") and Region.str.contains("World")', engine='python')[str(year)]/remind.query('Variable == ("Population") and Region.str.contains("World")', engine='python')['2040']
...
ownership_cost_scaling = (1-bike_share/car_load_factor)*remind.query('Variable == ("GDP|per capita|MER") and Region.str.contains("World")', engine='python')[str(year)]/remind.query('Variable == ("GDP|per capita|MER") and Region.str.contains("EUR")', engine='python')['2020'].iloc[0]
...
congestion = (1-bike_share/car_load_factor)*remind.query('Variable == ("GDP|MER") and Region.str.contains("World")', engine='python')[str(year)] 
...
Road_accidents_DALY['value'] =  literature.query('variable == ("Road_accidents") and unit.str.contains("DALY")', engine='python')['value_lit'] * pop_scaling_2020.iloc[0,] * vkm_scaling_2020.iloc[0,] * (1-bike_share/car_load_factor)
...
Road_accidents_premature_deaths['value'] =  literature.query('variable == ("Road_accidents") and unit.str.contains("premature death")', engine='python')['value_lit'] * pop_scaling_2020.iloc[0,]* vkm_scaling_2020.iloc[0,]  * (1-bike_share/car_load_factor)

Road_noise = literature.query('variable == ("Road_noise") and unit.str.contains("DALY")', engine='python')

Road_noise['value'] =  literature.query('variable == ("Road_noise") and unit.str.contains("DALY")', engine='python')['value_lit'] * pop_scaling_2010_EU.iloc[0,]* vkm_scaling_2020.iloc[0,]  * (1-bike_share/car_load_factor)
...
literature_bike_share = pd.concat([Physical_activity_health_impact_GBD_DALY,
								   ...
								   tire_microplastic])  
literature_bike_share['scenario'] = "ldv_total_bike share "+str(bike_share)

literature_bike_share = literature_bike_share[['scenario', 'variable', 'unit','value']]
...
literature = pd.concat([Physical_activity_health_impact_GBD_DALY,
                                   ...
                                   Congestion_fuel_time_waste,
								   tire_microplastic])  
literature['scenario'] = "ldv_total"
literature = literature[['scenario', 'variable', 'unit','value']]

literature= pd.concat([literature,literature_bike_share])
